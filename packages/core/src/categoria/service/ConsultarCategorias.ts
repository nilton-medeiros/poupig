import { CategoriaProps, UsuarioProps } from '../..'
...
export default class ConsultarCategorias implements CasoDeUso<UsuarioProps, CategoriaProps[]> {
    constructor(private repo: RepositorioCategoria) {}

    async executar(usuario: UsuarioProps): Promise<Resultado<CategoriaProps[]>> {
