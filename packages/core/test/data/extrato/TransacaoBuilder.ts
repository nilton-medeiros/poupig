...
export default class TransacaoBuilder {
    ...
    consolidada(consolidade: boolean): TransacaoBuilder {
        this.props.consolidada = consolidade
        return this
    }
    ...
    emMemoria(emMemorai: boolean): TransacaoBuilder {
        this.props.emMemoria = emMemorai
        return this
    }
