...
import { MonitorarAut, PararMonitoramentoAut, ProvedorAutenticacao } from 'core'
...
export default class FirebaseAuthProvider implements ProvedorAutenticacao {
    ...
    async loginComProvedor(providerId: string): Promise<UsuarioDTO | null> {
    ...
    private async _normalizedUser(firebaseUser: User): Promise<UsuarioDTO> {
